    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <header className="border-b border-primary/10">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="text-2xl font-bold text-primary">Mangoloids</div>
          <ThemeToggle />
        </div>
      </header>
      ...
      <footer className="border-t border-primary/10">
        <div className="mx-auto flex max-w-6xl items-center justify-center px-6 py-8 text-center text-sm text-foreground/60">
          <p>&copy; 2026 Guild. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
